...
//
public class YprojectService {
	Scanner sc = new Scanner(System.in);
	YprojectRepository prepository = new YprojectRepository();
...
//	}
	...
	public YprojectDTO throwYut(String player) {
		YprojectDTO proYDTO = new YprojectDTO();
		totalcnt++;
		if (player.equals("A")) {
			playerAcnt++;
		} else {
